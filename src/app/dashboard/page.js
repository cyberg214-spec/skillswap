...
export default function Dashboard() {
  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <p className="text-indigo-600 text-lg font-medium animate-pulse">Loading your dashboard...</p>
    </div>
  );
  ...
  const learnSkills = profile?.learn || [];
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <div className="flex flex-wrap gap-2">
              {teachSkills.length === 0 && <p className="text-gray-400 text-sm">No skills added yet</p>}
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <div className="flex flex-wrap gap-2">
              {learnSkills.length === 0 && <p className="text-gray-400 text-sm">No skills added yet</p>}
