          ...
          <div className="flex flex-col gap-4">
            {incoming.length === 0 ? (
              <div className="text-center py-20 text-gray-400">
                ...
                <p className="text-sm mt-1">Share your profile to get requests!</p>
              </div>
            ) : (
              incoming.map(req => (
                <div
                  key={req.id}
                  className="bg-white rounded-2xl shadow-sm p-6 flex items-center justify-between border border-gray-100"
                >
